...
SimpleForm.setup do |config|
  ...
  config.wrappers :vertical_select, tag: 'div', class: 'mb-3', error_class: 'form-group-invalid', valid_class: 'form-group-valid' do |b|
    b.use :html5
    b.use :placeholder
    b.optional :maxlength
    b.optional :minlength
  ...
  config.wrappers :vertical_collection, item_wrapper_class: 'form-check d-flex', item_label_class: 'form-check-label', tag: 'fieldset', class: 'mb-3', error_class: 'form-group-invalid', valid_class: 'form-group-valid' do |b|
    b.use :html5
    b.optional :readonly
